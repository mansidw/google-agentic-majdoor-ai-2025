...
class DemoGeneric:
    ...
    def __init__(self):
        self.key_file_path = os.environ.get(
            "GOOGLE_APPLICATION_CREDENTIALS", "gwallet_sa_keyfile.json"
        )
    ...
    def patch_class(self, issuer_id: str, class_suffix: str) -> str:
        ...
        if existing_class.get("linksModuleData"):
            patch_body["linksModuleData"] = existing_class.get("linksModuleData")
        else:
    ...
    def create_jwt_existing_objects(
        self, issuer_id: str, object_suffix: str, class_suffix: str
    ) -> str:
    ...
    # def create_jwt_for_existing_object(
    #     self, issuer_id: str, class_suffix: str, object_suffix: str
    # ) -> str:
    #     """
    #     Generate a signed JWT that references an existing pass object.
    ...
    #     Args:
    #         issuer_id (str): The issuer ID being used for this request.
    #         class_suffix (str): The suffix of the pass class.
    #         object_suffix (str): The suffix of the pass object.

    #     Returns:
    #         An "Add to Google Wallet" link.
    #     """

    #     # The payload that specifies which object to link to the user.
    #     payload = {
    #         "iss": self.credentials.service_account_email,
    #         "aud": "google",
    #         "typ": "savetowallet",
    ...
    #     # Sign the JWT with the service account credentials
    #     try:
    #         signer = crypt.RSASigner.from_service_account_file(self.key_file_path)
    #         token  = jwt.encode(signer, claims).decode("utf-8")
    #         print("✅ Successfully signed JWT.")
    #         return f"https://pay.google.com/gp/v/save/{token.decode('utf-8')}"
